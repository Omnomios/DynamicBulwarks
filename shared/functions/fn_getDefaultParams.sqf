...
private _defaultBulwarkParams = [ 
	...
	[ 
		...
		"Excluded DLC content", PARAM_CATEGORY_FILTERS, PARAM_TYPE_NUMBER, 0, 
		[ ["None", 0], ["Contact", 1] ], 
		0, 
	...
	[ 
		...
		"Presets", PARAM_CATEGORY_FILTERS, PARAM_TYPE_NUMBER, 0, 
	...
	[ 
		...
		"Base hostiles wave multiplier", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[ 
		...
		"Hostiles per player multiplier", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Hostiles restricted to pistols until wave", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Dead bodies remain for this many waves", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Down time between waves", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Maximum number of waves", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Increase special wave variety?", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
		[["No", 0], ["Yes", 1]],
		1,
	...
	[
		...
		"Vehicles may spawn after wave", PARAM_CATEGORY_WAVE, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Start with a map?", PARAM_CATEGORY_START, PARAM_TYPE_NUMBER, 0,
		[ ["No", 0], ["Yes", 1]],
		1,
	...
	[
		...
		"Start with a pistol?", PARAM_CATEGORY_START, PARAM_TYPE_NUMBER, 0,
		[ ["No", 0], ["Yes", 1]],
		0,
	...
	[
		...
		"Start with NVGs?", PARAM_CATEGORY_START, PARAM_TYPE_NUMBER, 0,
		[ ["No", 0], ["Yes", 1]],
		0,
	...
	[
		...
		"Randomize hostile weapons?", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
		[ ["No", 0], ["Yes", 1]],
		0,
	...
	[
		...
		"Point hitmarkers on HUD?", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
		[ ["No", 0], ["Yes", 1]],
		1,
	...
	[
		...
		"Minimum buildings near bulwark", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Loot distribution", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Loot density", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Supply drop distance", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Earliest mission time start", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Latest mission time start", PARAM_CATEGORY_GAME, PARAM_TYPE_NUMBER, 0,
		[ ["0200 hours", 2], ["0400 hours", 4], ["0600 hours", 6], ["0800 hours", 8], ["1000 hours", 10], ["1200 hours", 12], ["1400 hours", 14], ["1600 hours", 16], ["1800 hours", 18], ["2000 hours", 20]],
		7,
	...
	[
		...
		"Mission area size", PARAM_CATEGORY_GEOGRAPHY, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Minimum spawn room size", PARAM_CATEGORY_GEOGRAPHY, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Minimum land/water ratio", PARAM_CATEGORY_GEOGRAPHY, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Starting position", PARAM_CATEGORY_GEOGRAPHY, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Medikits in bulwark", PARAM_CATEGORY_BULWARK, PARAM_TYPE_NUMBER, 0,
		[],
		3,
	...
	[
		...
		"Upgrades require Satellite dish", PARAM_CATEGORY_UPGRADES, PARAM_TYPE_NUMBER, 0,
		[["No", 0], ["Yes", 1]],
		1,
	...
	[
		...
		"Points per kill", PARAM_CATEGORY_UPGRADES, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Points per hit", PARAM_CATEGORY_UPGRADES, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Damage bonus points", PARAM_CATEGORY_UPGRADES, PARAM_TYPE_NUMBER, 0,
		[["0", 0], ["10", 10], ["20", 20], ["50", 50], ["100", 100]],
		2,
	...
	[
		...
		"Paratrooper count", PARAM_CATEGORY_UPGRADES, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Revive required items", PARAM_CATEGORY_PLAYER, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Respawn tickets", PARAM_CATEGORY_PLAYER, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Respawn time", PARAM_CATEGORY_PLAYER, PARAM_TYPE_NUMBER, 0,
	...
	[
		...
		"Enable friendly fire?", PARAM_CATEGORY_PLAYER, PARAM_TYPE_NUMBER, 0,
		[ ["No", 0], ["Yes", 1] ],
		1,

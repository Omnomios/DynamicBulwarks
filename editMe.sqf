...
BULWARK_BUILDITEMS = [
    ...
    [1000, "Dragons Tooth",        "Land_DragonsTeeth_01_1x1_new_F",    0,   4],
    ...
    [4000, "Small Dome",           "Land_Dome_Small_F",                 0, 1.5],
    [4500, "Pillbox",              "Land_PillboxBunker_01_hex_F",      90, 2.5],
    [4500, "Rectangle Pillbox",    "Land_PillboxBunker_01_rectangle_F", 0,   1],
    [5000, "Airstrip Platform",    "Land_AirstripPlatform_01_F",        0,   3],
    [6000, "Guard Tower",          "Land_Cargo_Patrol_V3_F",            0, 3.5],
    [6000, "Large Dome",           "Land_Dome_Big_F",                 180, 1.5],
    [8000, "Big Pillbox",          "Land_PillboxBunker_01_big_F",       0, 1.5],
    [9500, "Modular Bunker",       "Land_Bunker_01_Small_F",          180, 3.5],
    [9500, "HQ Mod. Bunker",       "Land_Bunker_01_HQ_F",               0,   2],
    [10000,"Tall Mod. Bunker",     "Land_Bunker_01_tall_F",           180,   1],
    [10000,"Big Mod. Bunker",      "Land_Bunker_01_big_F",              0, 3.5]
];
